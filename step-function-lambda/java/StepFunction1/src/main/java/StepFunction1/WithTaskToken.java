...
// this code was finally used in step function

public class WithTaskToken implements RequestHandler<Object, Object> {
	...
	public Object handleRequest(Object input, Context context) {
		...
		dynamoDb.getTable(DYNAMODB_TABLE_NAME).putItem(new PutItemSpec()
				.withItem(new Item().withString("execution_arn", executionArn).withString("task_token", taskToken)));
		return input;
	}
