...
const SearchCatalogueDetails = () => {
    ...
    function searchJsonCatalogue() {
        var searchServiceCatalogue = {
            FunctionName: 'aws-node-http-api-project-dev-search_catalogues_details',
            Payload: searchInput
        };
        lambda.invoke(searchServiceCatalogue, function (err, data) {
        ...
        <>
            ...
            <div className='d-flex justify-content-around'>
                <div className='d-flex flex-column myBox' style={{ width: "600px" }}>
                    <h6>Search Catalogue_Details</h6>
                    ...
                    <div className='d-flex'>
                        <button className='btn btn-info m-2 mt-3' style={{ width: "50%" }} onClick={searchJsonCatalogue}>Search Input</button>
                ...
                <div className='d-flex flex-column myBox' style={{ width: "800px" }}>
                    ...
                    <div style={{ marginLeft: "95%", marginTop: "-40px" }}>
                        <CopyToClipboard text={JSON.stringify(viewSearchInput)} onCopy={onCopyText1}>
                            <span>{isCopied1 ? "Copied!" : <a href='3'> <MdContentCopy /></a>}</span>
                        </CopyToClipboard>
                    </div>
                    <hr />
                    <div class="scrollbar" id="style-default">
...
export default SearchCatalogueDetails;