...
const DeleteServiceDetails = () => {
    ...
    function deleteJson() {
        var deleteService = {
            FunctionName: 'aws-node-http-api-project-dev-delete_service_details',
            Payload: deleteInput
        };
        lambda.invoke(deleteService, function (err, data) {
            if (err) {
    ...
    function PrettyPrint() {
        const a = JSON.parse(deleteInput);
        setDeleteInput(JSON.stringify(a, null, 2))
    }
    return (
        <>
            <center>
            ...
            <div className='d-flex justify-content-around'>
                <div className='d-flex flex-column myBox' style={{ width: "400px" }}>
                    ...
                    <div className='d-flex'>
                        <button className='btn btn-info m-2 mt-3' style={{ width: "50%" }} onClick={deleteJson}>Delete Input</button>
