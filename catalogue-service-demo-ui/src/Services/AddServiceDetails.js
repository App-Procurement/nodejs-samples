...
const AddServiceDetails = () => {
    ...
    function addJson() {
        var addService = {
            FunctionName: 'aws-node-http-api-project-dev-add_service_details',
            Payload: input
        };
        lambda.invoke(addService, function (err, data) {
            if (err) {
            ...
            <div className='d-flex justify-content-around'>
                <div className='d-flex flex-column myBox' style={{ width: "600px" }}>
                    ...
                    <div className='d-flex'>
                        <button className='btn btn-info m-2 mt-3' style={{ width: "50%" }} onClick={addJson}>Add Input</button>
                ...
                <div className='d-flex flex-column myBox' style={{ width: "800px" }}>
                    ...
                    {/* <textarea disabled value={searchedData} style={{ wordWrap: "break-word", height: "400px" }} /> */}
                    <div class="scrollbar" id="style-default">
                        <div class="force-overflow">
                            <div class="modal-body">
