exports.upadte_quotation = async (event, context, callback) => {
    ...
    try {
        ...
        if (event.id) {
            ...
            const res = await client.query(`UPDATE quotation SET details= $1::jsonb WHERE id = $2`, [event.details, event.id]);
